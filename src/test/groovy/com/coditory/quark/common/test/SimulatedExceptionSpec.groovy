...
import com.coditory.quark.commons.throwable.Throwables
...
class SimulatedExceptionSpec extends Specification {
    def "should throw SimulatedException without stacktrace"() {
        ...
        then:
            ...
            Throwables.getStackTrace(exception) == "com.coditory.commons.test.SimulatedException: ¯\\_(ツ)_/¯ just a simulation\n"
    }
    ...
    def "should throw SimulatedCheckedException without stacktrace"() {
        ...
        then:
            ...
            Throwables.getStackTrace(exception) == "com.coditory.commons.test.SimulatedCheckedException: ¯\\_(ツ)_/¯ just a simulation\n"
    }
}
