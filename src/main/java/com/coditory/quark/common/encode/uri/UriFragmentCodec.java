...
import static com.coditory.quark.common.text.Alphabets.URI_FRAGMENT_UNRESERVED;

public final class UriFragmentCodec {
    private static final TranslationCodec CODEC = PercentCodec.builder()
            .spaceAsPlus(false)
            .safeCharacters(URI_FRAGMENT_UNRESERVED)
            .build();
